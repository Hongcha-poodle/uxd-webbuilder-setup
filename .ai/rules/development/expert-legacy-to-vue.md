...
- **변환 단계**:
  ...
  - `@.ai/rules/development/component-guardrails.md`의 Props guardrail을 적용합니다. 레거시 소스에 근거 없는 계약 확장은 피하고, 불명확하면 최소 `Emits` 중심으로 유지합니다.
...
- **행동 지침**:
  ...
  - **부분 수정**: `@.ai/rules/development/component-guardrails.md`의 partial edit guardrail을 적용하여 변경 요청에 해당하는 부분만 안전하게 교체하거나 업데이트합니다.
